...
const service: string = import.meta.env.VITE_EMAILJS_SERVICE_ID;
const template: string = import.meta.env.VITE_EMAILJS_TEMPLATE_ID;
const user: string = import.meta.env.VITE_EMAILJS_USER_ID;
